...
function preset() {
  return { renderScale: 1, maxPixelRatio: 1, shadows: false, postProcessing: false, shadowMapSize: 1024, shadowCascades: 1, ssao: false, bloom: false, antialias: 'none' as const, maxInstances: 10, drawDistance: 200, textureBudgetMb: 64, anisotropy: 1, volumetricFog: false };
}
