...
/**
 * End-to-end suite: the game boots and plays through the browser.
 *
 * Serves the production build with `vite preview` on port 4173 so the suite
    ...
    [
      'html',
      {
        ...
        outputFolder: fileURLToPath(
          new URL('../../playwright-report/e2e', import.meta.url),
        ),
      },
    ],
  ],
